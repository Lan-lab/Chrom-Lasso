...
7. please edit in "Chrom-Lasso/Code/2_Arrange_Domain/HiC_mixturePLD_main.cpp". Users should add an `else if` to tell the length of chromosomes for this genome version.<br>
