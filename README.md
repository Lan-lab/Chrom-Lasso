...
#### Domain file
The domain file contains the genomic regions identified as TADs.
![domain file](![cutting site file](https://github.com/Lan-lab/Chrom-Lasso/blob/main/documentation/domain_file.png))
