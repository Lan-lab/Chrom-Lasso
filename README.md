...
5. When testing for the reads distribution surrounding potential interacting loci pair, Chrom-Lasso defines the testing range by parameter "" in `cpp code`, when this parameter is 1, it defines a 11 cutting site window centered by the potential loci, and you can change this parameter in Cpp code to satisfy the needs of study. This parameter should be changed in "/Code/4_Find_IntraDomain_Interaction/findIntraDomainInteraction.cpp", and "/Code/6_Test_Distribution/outputTestPosPvalue.cpp" at the same time.<br>
