...
please edit in "/Code/2_Arrange_Domain/HiC_mixturePLD_main.cpp". Users should add an `else if` to tell the length of chromosomes for this genome version as below.<br>
